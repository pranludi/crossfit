package io.pranludi.crossfit.branch.config.security.common;

import io.jsonwebtoken.Jwts;
import io.jsonwebtoken.security.Keys;
import io.pranludi.crossfit.branch.config.security.server.ServerTokenClaims;
import io.pranludi.crossfit.branch.config.security.server.ServerType;
...
public class ServerTokenUtil {
    ...
    SecretKey secretKey;
    final long expiration = 86400000; // 24시간 (서버 토큰은 더 긴 유효기간)
